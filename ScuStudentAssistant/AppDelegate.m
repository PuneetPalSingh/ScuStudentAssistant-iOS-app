...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[UITabBar appearance] setBarTintColor:[UIColor colorWithRed:0.6 green:0 blue:0 alpha:1]];
    
    //changes appearance of TabBar
    [[UITabBar appearance] setTintColor:[UIColor blackColor]];
    [[UIToolbar appearance] setBarTintColor:[UIColor darkGrayColor]];
    [[UIToolbar appearance] setTintColor:[UIColor blackColor]];
    [[UICollectionView appearance] setBackgroundColor:[UIColor darkGrayColor]];
